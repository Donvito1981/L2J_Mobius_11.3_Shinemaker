...
public class ConquestEngine extends AbstractNpcAI
{
	...
	private long getMillisToConquestSeasonEnd()
	{
		...
		String customConfigDate = now.getYear() + "-" + now.getMonthValue() + "-" + Config.CONQUEST_RESET_DAY;
		String defaultConfigDate = now.getYear() + "-" + now.getMonthValue() + "-" + now.toLocalDate().lengthOfMonth();
